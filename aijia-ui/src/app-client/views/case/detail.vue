...
<template>
    <div class="view-container view-detail">
        <div>this is client case detail page</div>
    </div>
</template>
<script lang="ts">
    ...
    export default class CaseDetailView extends Vue {
        private name: string = 'CaseDetailView';
